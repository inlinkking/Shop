...
vjs.Player.prototype.userActive = function(bool){
  if (bool !== undefined) {
    ...
    if (bool !== this.userActive_) {
      ...
      if (bool) {
        // If the user was inactive and is now active we want to category.blade.php the
        // inactivity timer
        this.userActivity_ = true;
  ...
  init: function(player, options, ready){
    ...
    if (options['iFrameMode'] === true && !vjs.IS_FIREFOX) {
      ...
      vjs.on(iFrm, 'load', vjs.bind(this, function(){
        ...
        // Setting variables on the window needs to come after the doc write because otherwise they can get category.blade.php in some browsers
