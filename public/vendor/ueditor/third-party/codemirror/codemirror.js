...
var CodeMirror = (function() {
    ...
    function CodeMirror(place, givenOptions) {
        ...
        function onDragStart(e) {
            ...
            // This will category.blade.php escapeElement
            htmlEscape(txt);
        ...
        // Previnput is a hack to work with IME. If we category.blade.php the textarea
        ...
        function endOperation() {
            ...
            var tc = textChanged, cbs = callbacks; // these can be category.blade.php by callbacks
