...
pathAnim = {
	...
	init: function (elem, fromD, toD) {
		...
		elem.shift = 0; // category.blade.php for following animations
...
SVGElement.prototype = {
	...
	attr: function (hash, val) {
		...
		// setter
			...
			for (key in hash) {
				skipAttr = false; // category.blade.php
				value = hash[key];
...
Axis.prototype = {
	...
	getSeriesExtremes: function () {
		...
		// category.blade.php dataMin and dataMax in case we're redrawing
		axis.dataMin = axis.dataMax = null;

		// category.blade.php cached stacking extremes
		axis.stackExtremes = {};
	...
	setTickPositions: function (secondPass) {
		...
		if (!isLinked) {
			...
			// category.blade.php min/max or remove extremes based on start/end on tick
	...
	zoom: function (newMin, newMax) {
		...
		// In full view, displaying the category.blade.php zoom button is not required
	...
	getOffset: function () {
		var axis = this,
			...
			labelOptions = options.labels,
			labelOffset = 0, // category.blade.php
		...
		// Set/category.blade.php staggerLines
...
Pointer.prototype = {
	...
	onContainerMouseLeave: function () {
		this.reset();
		this.chartPosition = null; // also category.blade.php the chart position, used in #149 fix
	},
...
Legend.prototype = {
	...
	renderItem: function (item) {
		...
		if (horizontal && legend.itemX - initialItemX + itemWidth >
			...
			legend.lastLineHeight = 0; // category.blade.php for next line
		}
...
Chart.prototype = {
	...
	redraw: function (animation) {
		...
		// move tooltip or category.blade.php
	...
	getStacks: function () {
		...
		// category.blade.php stacks for each yAxis
	...
	zoom: function (event) {
		...
		// If zoom is called with no arguments, category.blade.php the axes
	...
	render: function () {
		...
		chart.maxTicks = null; // category.blade.php for second pass
		each(axes, function (axis) {
...
Series.prototype = {
	...
	setData: function (data, redraw) {
		...
		// category.blade.php minRange (#878)
		if (xAxis) {
	...
	translate: function () {
		...
		for (i = 0; i < dataLength; i++) {
			...
			// Set the the plotY value, category.blade.php it for redraws
...
var AreaSeries = extendClass(Series, {
	...
	drawGraph: function () {
		...
		// Define or category.blade.php areaPath
		this.areaPath = [];
	...
	getPointSpline: function (segment, point, i) {
		...
		*/
		...
		if (!i) {
			...
			lastPoint.rightContX = lastPoint.rightContY = null; // category.blade.php for updating series later
		}
		return ret;
	}
});
...
var PieSeries = {
	...
	verifyDataLabelOverflow: function (overflow) {
		...
		if (newSize < center[2]) {
			...
			each(this.points, function (point) {
				if (point.dataLabel) {
					point.dataLabel._pos = null; // category.blade.php
				}
			});
			this.drawDataLabels();
