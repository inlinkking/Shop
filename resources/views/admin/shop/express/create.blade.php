        ...
        <div class="admin-content-body">
            <div class="am-cf am-padding am-padding-bottom-0">
                <div class="am-fl am-cf">
                    <strong class="am-text-primary am-text-lg">添加快递方式</strong> /
                    <small>Create Express</small>
                </div>
            </div>
            <hr>
            <div class=" am-margin">
                    ...
                    <form class="am-form" action="{{route('shop.express.store')}}" method="post">
                        ...
                        <div class="am-g am-margin-top">
                            ...
                            <div class="am-u-sm-8 am-u-md-4 am-u-end col-end">
                                <input type="text" name="code" class="am-input-sm">
                            </div>
                        ...
                        <div class="am-g am-margin-top">
                            ...
                            <div class="am-u-sm-8 am-u-md-4 am-u-end col-end">
                                <input type="text" name="shipping_money" class="am-input-sm">
                            </div>
                        </div>
                        ...
                        <div class="am-g am-margin-top">
                            ...
                            <div class="am-u-sm-8 am-u-md-4 am-u-end col-end">
                                <input type="text" name="shipping_free" class="am-input-sm">
                            </div>
                        </div>
                        ...
                        <div class="am-g am-margin-top">
                            ...
                            <div class="am-u-sm-8 am-u-md-4 am-u-end col-end">
                                <textarea name="description" rows="5" class="am-input-sm"></textarea>
                            </div>
                        </div>
                        ...
                        <div class="am-g am-margin-top">
                            ...
                            <div class="am-u-sm-8 am-u-md-4 am-u-end col-end">
                                <input type="text" name="sort_order" value="99" class="am-input-sm">
                            </div>
                        </div>
