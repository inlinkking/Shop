...
@section('content')
    <div class="page-address-edit" data-log="编辑地址">
        <div class="header">
            <div class="left">
                <img src="http://s1.mi.com/m/images/m/icon_back_n.png" class="ib" border="0"
                     onclick="javascript:history.back(-1);" title="返回上一页">
            </div>
            <div class="tit"><h2 data-log="HEAD-标题-商品列表"><span class="title">编辑地址</span></h2></div>
        ...
        <div class="edit-box">
            <ul class="ui-list">
                <li class="ui-list-item">
                    ...
                    <div class="ui-input">
                        <input placeholder="真实姓名" value="{{$address->name}}" name="name" maxlength="15"
                               type="text">
                    </div>
                </li>
                <li class="ui-list-item">
                    ...
                    <div class="ui-input">
                        <input placeholder="手机号" value="{{$address->tel}}" id="tel" name="tel" type="tel">
                    </div>
                </li>
                <li class="ui-list-item">
                    <div class="label">所在地区：</div>
                    <div class="ui-input">
                        <input placeholder="省 市 区" id="pca" name="pca" maxlength="20" type="text" readonly="readonly"
                               value="{{$address->province}} {{$address->city}} {{$address->area}}">
                    </div>
                </li>
                <li class="ui-list-item">
                    <div class="label">街道地址：</div>
                    <div class="ui-input">
                        <input placeholder="详细地址" value="{{$address->address}}" name="address" maxlength="120"
                               type="text">
                    </div>
                </li>
            </ul>
            <div class="save-button">
                <a href="javascript:void(0);" class="ui-button">
                    <span>保存地址</span>
                </a>
            </div>
        </div>
